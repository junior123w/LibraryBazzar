...
namespace LibraryBazzar.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,BookId,Title,ReviewDate,Rating,Comments")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,BookId,Title,ReviewDate,Rating,Comments")] Review review)
        {
